...
public class RewardNotification {
    ...
    public RewardNotification withInvoiceNumber(String invoiceNumber) {
        this.invoiceNumber = invoiceNumber;
        return this;
    }
    ...
    public RewardNotification withCustomerCardNo(String customerCardNo) {
        this.customerCardNo = customerCardNo;
        return this;
    }
    ...
    public RewardNotification withTotalAmount(Double totalAmount) {
        this.totalAmount = totalAmount;
        return this;
    }
    ...
    public RewardNotification withEarnedLoyaltyPoints(Double earnedLoyaltyPoints) {
        this.earnedLoyaltyPoints = earnedLoyaltyPoints;
        return this;
    }
    ...
    public RewardNotification withTotalLoyaltyPoints(Double totalLoyaltyPoints) {
        this.totalLoyaltyPoints = totalLoyaltyPoints;
        return this;
    }
